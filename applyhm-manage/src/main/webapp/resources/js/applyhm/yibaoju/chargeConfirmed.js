...
$(function() {
	datagrid = $('#datagrid').datagrid({
		method:'get',
		url : projectName+'/yibaoju/charge/admin/list?status_s=1&v_date=' + new Date().getTime(),
		pagination : true,
		pageSize : 200,
		pageList : [ 50,100,200 ],
		fit : true,
...
function exportExcel(){
	window.location.href = projectName + '/yibaoju/charge/admin/exportExcel?status_s=1&' + $("#yibaojuChargeSearchForm").serialize();
}
