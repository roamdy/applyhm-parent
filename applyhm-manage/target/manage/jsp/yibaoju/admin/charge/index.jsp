...
<body class="easyui-layout" fit="true">
	...
	<div data-options="region:'center'" border="false" style="position:relative;overflow: hidden;width:85%">
    	<table id="datagrid"></table>
    </div>
</body>
<script type="text/javascript" charset="UTF-8" src="<%=request.getContextPath()%>/resources/js/applyhm/yibaoju/charge.js?date=<%=System.currentTimeMillis() %>"></script>
</html>